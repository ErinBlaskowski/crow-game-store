        ...
        <main class="main">
            <section class="left-flex">
                <div class="flex-item3">
                    <a href="/crow-game-store/store"><img src={diceTrayGame} alt="300x600" height="600px" width="400"></img></a>
            ...
            <section class="mid-flex">
                <div class="flex-item">
                    <section class="box">
                        <a href="/crow-game-store/store"><img src={diceSet} height="150px" width="200px" alt="200x50"></img></a>
                        <h3>White Dice Set - $13.99</h3>
                    </section>
                </div>
                <div class="flex-item">
                    <section class="box">
                        <a href="/crow-game-store/store"><img src={dominos} height="150px" width="200px" alt="200x50"></img></a>
                        <h3>Dominos - $15.99</h3>
                    </section>
                </div>
                <div class="flex-item2">
                    <section class="box">
                        <a href="/crow-game-store/store"><img src={funkyChessSet} height="150px" width="200px" alt="200x50"></img></a>
                        <h3>Layered Chess Set - $44.99</h3>
                    </section>
                </div>
                <div class="flex-item2">
                    <section class="box">
                        <a href="/crow-game-store/store"><img src={setOfEightPuzzles} height="150px" width="200px" alt="200x50"></img></a>
